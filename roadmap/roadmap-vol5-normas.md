# ⚖️ Roadmap Vol. 5 — NORMAS, QUALIDADE E LEGISLAÇÃO
...
1. ⚖️ Normas, Qualidade e Legislação — Guia
2. ⭐ Qualidade de Produto — ISO/IEC 25010
3. 🔄 Qualidade de Processo — 12207, CMMI, MPS.BR, DORA
4. 📋 Requisitos, Arquitetura e Documentação
5. 🧪 Testes e Verificação — 29119, ISTQB
6. 🔒 Segurança — ISO 27001, OWASP, NIST SSDF, Supply Chain
7. 📏 Métricas Objetivas de Qualidade de Código
8. ♿ Acessibilidade — WCAG, LBI, eMAG
9. 🇧🇷 Legislação Brasileira — LGPD, Marco Civil, Lei do Software
10. 🌍 Legislação Internacional — GDPR, CRA, AI Act, NIS2
11. 🚨 Sistemas Críticos — IEC 61508, 62443, 61131
12. 🤖 Normas e Regulação de IA
13. 🏢 Governança de TI — COBIT, ITIL, TOGAF
...
# ♿ Acessibilidade — WCAG, LBI, eMAG

> Parte VII (Vol. 4). É lei no Brasil.
...
# 🤖 Normas e Regulação de IA

> Parte XI (Vol. 4): ISO 42001, NIST AI RMF, PL 2338/2023.
...
# 🏢 Governança de TI — COBIT, ITIL, TOGAF
